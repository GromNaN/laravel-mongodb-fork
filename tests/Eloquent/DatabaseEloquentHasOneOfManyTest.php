...
/**
 * Covers Eloquent features on "toMany" relationships.
 *
 * @see \Illuminate\Database\Eloquent\Relations\Concerns\CanBeOneOfMany
 * @see \Illuminate\Tests\Database\DatabaseEloquentHasOneOfManyTest
 */
